...
export function Bars3Svg({ className = "", toggleSidebar }) {
  return (
    <>
      <svg
...
export function XMarkSvg({ className = "", toggleSidebar }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function CodeSvg() {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className="lg:w-10 lg:h-10 w-6 h-6 dark:text-white"
    >
      <path
        fillRule="evenodd"
...
export function NightSvg({ className = "", toggleTheme }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function DaySvg({ className = "", toggleTheme }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
